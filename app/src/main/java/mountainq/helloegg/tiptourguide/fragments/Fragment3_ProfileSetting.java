...
/**
 * Created by cholmink on 2016-11-19.
 */

public class Fragment3_ProfileSetting extends FChildActivity {
    Button btn_account;
    Button btn_notice;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_customcenter = (Button) view.findViewById(R.id.btn_customcenter);
        btn_termcond = (Button) view.findViewById(R.id.btn_termcond);
        btn_personalinfo = (Button) view.findViewById(R.id.btn_personalinfo);
        ...
        switch1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    Toast.makeText(getActivity(), "푸쉬알람이 켜졌습니다!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getActivity(), "푸쉬알림이 꺼졌습니다!", Toast.LENGTH_SHORT).show();
                }
        ...
        switch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    Toast.makeText(getActivity(), "자동로그인이 설정 되었습니다!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getActivity(), "자동로그아웃이 설정 되었습니다!", Toast.LENGTH_SHORT).show();
        ...
        btn_notice.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog.Builder noticeBuilder = new AlertDialog.Builder(v.getContext());
                noticeBuilder.setTitle("공지");
                noticeBuilder.setMessage("공지 공사중 입니다!");
                noticeBuilder.setCancelable(true);
                noticeBuilder.setPositiveButton("확인", new CancelOnClickListener()).show();
            }

        });
        btn_report.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog.Builder reportBuilder = new AlertDialog.Builder(v.getContext());
                reportBuilder.setTitle("신고");
                reportBuilder.setMessage("신고 공사중 입니다!");
                reportBuilder.setCancelable(true);
                reportBuilder.setPositiveButton("확인", new CancelOnClickListener()).show();
            }

        });
        btn_customcenter.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                customBuilder.setPositiveButton("확인", new CancelOnClickListener()).show();
            }

        });
        btn_termcond.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog.Builder termcondBuilder = new AlertDialog.Builder(v.getContext());
                ...
                termcondBuilder.setPositiveButton("확인", new CancelOnClickListener()).show();
            }

        });
        btn_personalinfo.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog.Builder personalBuilder = new AlertDialog.Builder(v.getContext());
                ...
                personalBuilder.setPositiveButton("확인", new CancelOnClickListener()).show();
            }
    ...
    private final class CancelOnClickListener implements
        ...
        public void onClick(DialogInterface dialog, int which) {
            Toast.makeText(getActivity(), "닫았습니다", Toast.LENGTH_SHORT).show();
