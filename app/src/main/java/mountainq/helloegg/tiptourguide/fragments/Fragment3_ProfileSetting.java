...
public class Fragment3_ProfileSetting extends FChildActivity {
    ...
    private void init(View view){
        ...
        switchPush = (Switch) view.findViewById(R.id.switch_push);
        switchAutoLogin = (Switch) view.findViewById(R.id.switch_autologin);
    ...
    private void showTermcond(){
        AlertDialog.Builder termcondBuilder = new AlertDialog.Builder(getActivity());
    ...
    private void showPersonalInfo(){
        AlertDialog.Builder personalBuilder = new AlertDialog.Builder(getActivity());
